...
Cinematic, SEO-first personal website for **Vidapiena** — Francesco, Italian tour guide in Rio de Janeiro ([@vidapiena](https://www.instagram.com/vidapiena/)). Small-group favela experiences (Rocinha, Vidigal, Tavares Bastos) and the full-day premium tour "Un Giorno a Rio", guided in Italian, English and Portuguese.

> This is **Step 2** of a 3-step engagement: ① OTA platform setup (Airbnb / Viator / Civitatis / GetYourGuide + Bokun) → ② **this website** → ③ Meta/Instagram ads.

## What we're building

| Part | Description | Phase |
| :--- | :--- | :--- |
...
**Only the `vidapiena-website/` folder is tracked on GitHub** ([LeoItaly/vidapiena](https://github.com/LeoItaly/vidapiena)). The parent project folder contains client documents, credentials, IDs and financial data — it stays **local only, by design**. Never commit anything from outside this folder. See [docs/ASSETS-MAP.md](docs/ASSETS-MAP.md) for where local source material lives.

## Documentation

| Doc | Purpose |
| :--- | :--- |
| [docs/VISION.md](docs/VISION.md) | Product vision, SEO/GEO strategy, stack constraints, roadmap |
| [docs/REFERENCES.md](docs/REFERENCES.md) | Content & design references, inspiration galleries, imported skills/MCP inventory |
